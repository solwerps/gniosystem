...
export async function GET(request: Request) {
  try {
    ...
    // ============================
    // CONSULTA EN LA BASE DE DATOS (GNIO) CON PRISMA
    // ============================
    ...
    // Responder con los datos obtenidos de la base de datos
    return NextResponse.json({
      status: 200,
      data: retenciones,
    ...
    return NextResponse.json({
      status: 400,
      message: error.message || "Ocurrió un error al obtener retenciones IVA",
    });
  }
}
