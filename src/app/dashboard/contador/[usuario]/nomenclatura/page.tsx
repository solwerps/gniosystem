// src/app/dashboard/contador/[usuario]/nomenclatura/page.tsx
"use client";
...
export default function NomenclaturaListContador() {
      ...
      <main className="flex-1 bg-slate-100">
        <div className="max-w-6xl mx-auto p-6">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => router.push(`/dashboard/contador/${usuario}/nomenclatura/crear`)}
                ...
                {loading ? (
                  ...
                  rows.map((r) => (
                    <tr
                      ...
                      onClick={() => router.push(`/dashboard/contador/${usuario}/nomenclatura/${r.id}`)}
                    >
