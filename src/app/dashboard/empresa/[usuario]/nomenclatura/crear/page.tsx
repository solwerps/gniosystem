// src/app/dashboard/empresa/[usuario]/nomenclatura/crear/page.tsx
...
export default function CrearNomenclaturaEmpresa() {
                              ...
                              return (
                                <td key={fd as string} className={cx("px-3 py-2", disabled && "bg-slate-200")}>
                                  <select className="border rounded px-2 py-1" value={String(value)} disabled={disabled}
                                    ...
                                    {["BALANCE_GENERAL","ESTADO_RESULTADOS","CAPITAL"].map(t=><option key={t} value={t}>{t.replaceAll("_"," ")}</option>)}
                                  </select>
                                </td>
                              );
                            }
