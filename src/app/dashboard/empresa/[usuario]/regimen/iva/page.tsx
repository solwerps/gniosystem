// src/app/dashboard/empresa/[usuario]/regimen/iva/page.tsx
// src/app/dashboard/empresa/[usuario]/regimen/iva/page.tsx
"use client";
...
export default function RegimenIvaEmpresaPage() {
        ...
        <div className="max-w-7xl mx-auto p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              onClick={() => router.push(`/dashboard/empresa/${usuario}/regimen/iva/editar`)}
            >
              Editar Régimen
            </button>
          </div>
